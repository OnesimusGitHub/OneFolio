...
function One() {
  ...
  return (
    <section 
      id="home" 
      className='flex items-start justify-center md:items-start md:justify-center min-h-screen c-space'
    >
      <OneText />
      <ParallaxBackground />
      <figure 
      ...
      >
        <Canvas 
          dpr={isMobile ? [1, 1.5] : [1, 2]} // Limit pixel ratio on mobile for better performance
